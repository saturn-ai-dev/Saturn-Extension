...
const SettingsModal: React.FC<SettingsModalProps> = ({
    ...
    const handleOptimizationNext = () => {
        ...
        if (optimizationStep < optimizationQuestions.length - 1) {
            ...
            // Finish
            const optimized = `Based on your preferences:\n- Tone: ${newAnswers[0] || 'Default'}\n- Length: ${newAnswers[1] || 'Default'}\n- Format: ${newAnswers[2] || 'Default'}\n- Context: ${newAnswers[3] || 'General'}\n\n(Note: In a full implementation, this would be generated by Gemini)`;
            setCustomInstructions(customInstructions ? customInstructions + "\n\n" + optimized : optimized);
                                        ...
                                        <div className="w-full max-w-md space-y-6">
                                            ...
                                            <div className="flex justify-center pt-4">
                                                <button
                                                    ...
                                                    className="px-8 py-3 bg-zen-accent text-white rounded-full font-bold hover:scale-105 active:scale-95 transition-all shadow-lg hover:shadow-glow-lg"
                                                >
                                                    {optimizationStep === optimizationQuestions.length - 1 ? 'Finish' : 'Next'}
                                                </button>
                                            </div>
                                        </div>
                                    </div>
